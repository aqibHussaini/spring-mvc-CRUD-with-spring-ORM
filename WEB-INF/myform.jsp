...
<body>
	...
	<div class="container mt-5">
		<div class="row">
			...
			<div class="card">
			<div class="card-body">
			<form action="linkfromhandler" method="get">
					<div class="form-group">
						<label for="exampleFormControlInput1" class="form-label font-weight-bolder">Email
							link</label> <input type="text" class="form-control" name="link"
							id="exampleFormControlInput1" placeholder="mysite.com">
					</div>
					<div class="form-group">
